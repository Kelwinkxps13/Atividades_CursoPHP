                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input name="nome" type="text" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input name="cpf" type="text" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input name="senha" type="password" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input name="cargo" type="text" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                            </div>
                        </div>
